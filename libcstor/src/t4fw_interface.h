...
enum fw_port_mod_sub_type {
	...
	/*
	 * T7 doesn't have BCM5482 and BCM84856. So the values are reused
	 * in T7 for S7210-BT (AS21010J) and S7410-BT (MV88X3540).
	 */
	FW_PORT_MOD_SUB_TYPE_AS21010J=0x6,
	FW_PORT_MOD_SUB_TYPE_MV88X3540=0x7,
